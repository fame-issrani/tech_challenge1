...
import com.appdirect.beans.FailureResponse;
import com.appdirect.beans.RootBean;
import com.appdirect.beans.ResponseSuccess;
...
public class Utilities {
	...
	public static RootBean extractDataFromJson(String jsonOutput) throws Exception {
		ObjectMapper obj = new ObjectMapper();
		com.fasterxml.jackson.databind.ObjectMapper mapper = new com.fasterxml.jackson.databind.ObjectMapper();
		RootBean pr = null;
		pr = mapper.readValue(jsonOutput, RootBean.class);
		return pr;
